...
router.post('/', async (req, res) => {
  ...
  try {
    const { name, agentId, projectPath, securityMode, postTaskHook, extraMounts, enableWorktree } = req.body;
...
router.put('/:id', async (req, res) => {
  try {
    ...
    const { name, agentId, projectPath, securityMode, authType, postTaskHook, extraMounts, enableWorktree } = req.body;
